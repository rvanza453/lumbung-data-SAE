                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <a href="pages/upload.php" class="btn btn-primary btn-lg w-100">
                                    <i class="fas fa-upload me-2"></i>
                                    Upload Data Baru
                                </a>
                            </div>
                            <div class="col-md-4 mb-3">
                                <a href="admin/file-manager.php" class="btn btn-success btn-lg w-100">
                            ...
                            <?php if ($_SESSION['role'] == 'admin'): ?>
                            <div class="col-md-4 mb-3">
                                <a href="admin/user-management.php" class="btn btn-warning btn-lg w-100">
                            ...
                            <?php else: ?>
                            <div class="col-md-4 mb-3">
                                <a href="admin/file-manager.php?kategori=panen" class="btn btn-info btn-lg w-100">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="admin/activity-logs.php" class="btn btn-sm btn-outline-primary">
                                ...
                                <tbody>
                                    ...
                                    try {
                                        ...
                                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            echo "<td><a href='scripts/download.php?id=" . $row['id'] . "' class='btn btn-sm btn-outline-primary'><i class='fas fa-download me-1'></i>" . $row['original_filename'] . "</a></td>";
                                            echo "</tr>";
                                        }
